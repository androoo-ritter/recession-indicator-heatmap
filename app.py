...
THRESHOLDS = {
    '3-Month': {'green': 3.5, 'yellow': 5.5, 'red_expl': 'Excessively high short-term interest rates'},
    '20-Year': {'green': 4.0, 'yellow': 5.5, 'red_expl': 'Long-term rates may signal inflation or instability'},
    '30-Year': {'green': 4.0, 'yellow': 5.5, 'red_expl': 'Long-term borrowing costs high'},
    ...
    'Consumer Sentiment': {'green': 75, 'yellow': 60, 'red_expl': 'Low consumer confidence'},
    'Continued Claims': {'green': 1500000, 'yellow': 2500000, 'red_expl': 'Extended unemployment'},
    'Core CPI': {'green': 2.5, 'yellow': 4, 'red_expl': 'Elevated core inflation'},
    'CPI': {'green': 2.5, 'yellow': 4, 'red_expl': 'Elevated inflation'},
    ...
    'Payrolls': {'green': 100000, 'yellow': 0, 'red_expl': 'Significant job loss'},
    'Real FFR': {'green': 1.5, 'yellow': 3.5, 'red_expl': 'Restrictive monetary policy'},
    'Real GDP': {'green': 0.5, 'yellow': 0, 'red_expl': 'Economic contraction'},
    'Retail Sales': {'green': 0.5, 'yellow': 0, 'red_expl': 'Declining consumer spending'},
    ...
    'Unemployment': {'green': 4.5, 'yellow': 6, 'red_expl': 'Labor market deterioration'},
...
FRED_SOURCES = {
    ...
    "Employment": "https://fred.stlouisfed.org/series/CE16OV",
