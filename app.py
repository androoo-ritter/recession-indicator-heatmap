...
THRESHOLDS = {
    ...
    '30-Year': {'green': 3.5, 'yellow': 4.5, 'red_expl': 'Long-term borrowing costs high'},
    'Bank Credit': {'green': 17500, 'yellow': 16500, 'red_expl': 'Contraction in lending activity (billions)'},
    'Claims': {'green': 250000, 'yellow': 300000, 'red_expl': 'Spike in unemployment claims'},
    'Consumer Sentiment': {'green': 80, 'yellow': 60, 'red_expl': 'Low consumer confidence'},
    'Continued Claims': {'green': 1800000, 'yellow': 2400000, 'red_expl': 'Extended unemployment'},
    'Core CPI': {'green': 2.0, 'yellow': 3.5, 'red_expl': 'Elevated core inflation'},
    'CPI': {'green': 2.0, 'yellow': 3.5, 'red_expl': 'Elevated inflation'},
    'Credit Card Delinquency': {'green': 2.5, 'yellow': 4.0, 'red_expl': 'Consumers struggling with debt'},
    'Loans and Leases': {'green': 12000, 'yellow': 11000, 'red_expl': 'Decrease in bank lending (billions)'},
    'M1': {'green': 17500, 'yellow': 16500, 'red_expl': 'Shrinking money supply (billions)'},
    ...
    'Payrolls': {'green': 150, 'yellow': 0, 'red_expl': 'Significant job loss (thousands)'},
    'Real FFR': {'green': 3.0, 'yellow': 4.5, 'red_expl': 'Restrictive monetary policy'},
    'Real GDP': {'green': 1.5, 'yellow': 0.0, 'red_expl': 'Economic contraction'},
    ...
    'SP500': {'green': 4800, 'yellow': 4200, 'red_expl': 'Major market decline (index level)'},
    'Transport Jobs': {'green': 6200, 'yellow': 6000, 'red_expl': 'Demand-side weakness (thousands)'},
