...
THRESHOLDS = {
    '3-Month': {'green': 4.5, 'yellow': 5.5, 'red_expl': 'Excessively high short-term interest rates'},
    '20-Year': {'green': 4.0, 'yellow': 5.0, 'red_expl': 'Long-term rates may signal inflation or instability'},
    '30-Year': {'green': 4.0, 'yellow': 5.0, 'red_expl': 'Long-term borrowing costs high'},
    'Bank Credit': {'green': 18000, 'yellow': 17500, 'red_expl': 'Contraction in lending activity (billions)'},
    'Claims': {'green': 250000, 'yellow': 300000, 'red_expl': 'Spike in unemployment claims'},
    'Consumer Sentiment': {'green': 70, 'yellow': 55, 'red_expl': 'Low consumer confidence'},
    'Continued Claims': {'green': 1800000, 'yellow': 2400000, 'red_expl': 'Extended unemployment'},
    'Core CPI': {'green': 3.0, 'yellow': 4.0, 'red_expl': 'Elevated core inflation'},
    'CPI': {'green': 3.0, 'yellow': 4.0, 'red_expl': 'Elevated inflation'},
    'Credit Card Delinquency': {'green': 2.5, 'yellow': 4.0, 'red_expl': 'Consumers struggling with debt'},
    'Loans and Leases': {'green': 10500, 'yellow': 10200, 'red_expl': 'Decrease in bank lending (billions)'},
    'M1': {'green': 18000, 'yellow': 16000, 'red_expl': 'Shrinking money supply (billions)'},
    'M2': {'green': 21000, 'yellow': 19000, 'red_expl': 'Shrinking broader money supply (billions)'},
    'Mortgage Delinquency': {'green': 2.0, 'yellow': 4.0, 'red_expl': 'Housing distress'},
    'Payrolls': {'green': 150, 'yellow': 50, 'red_expl': 'Significant job loss (thousands)'},
    'Real FFR': {'green': 2.0, 'yellow': 3.5, 'red_expl': 'Restrictive monetary policy'},
    'Real GDP': {'green': 1.0, 'yellow': 0.0, 'red_expl': 'Economic contraction'},
    'Retail Sales': {'green': 680000, 'yellow': 660000, 'red_expl': 'Declining consumer spending (millions)'},
    'Sahm': {'green': 0.4, 'yellow': 0.7, 'red_expl': 'Likely start of a recession'},
    'SP500': {'green': 4400, 'yellow': 3900, 'red_expl': 'Major market decline (index level)'},
    'Transport Jobs': {'green': 6100, 'yellow': 5900, 'red_expl': 'Demand-side weakness (thousands)'},
    'Unemployment': {'green': 4.0, 'yellow': 5.5, 'red_expl': 'Labor market deterioration'},
    'USHY': {'green': 5.0, 'yellow': 7.0, 'red_expl': 'Risk premium surging'},
    'USIG': {'green': 3.0, 'yellow': 4.5, 'red_expl': 'Credit stress in investment grade'},
